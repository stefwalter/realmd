...
static const GDBusErrorEntry ic_error_entries[] = {
	{ IC_ERROR_INTERNAL, IC_DBUS_ERROR_INTERNAL },
	{ IC_ERROR_DISCOVERY_FAILED, IC_DBUS_ERROR_DISCOVERY_FAILED },
	{ IC_ERROR_ENROLL_FAILED, IC_DBUS_ERROR_ENROLL_FAILED },
	{ IC_ERROR_UNENROLL_FAILED, IC_DBUS_ERROR_UNENROLL_FAILED },
	{ IC_ERROR_SET_LOGINS_FAILED, IC_DBUS_ERROR_SET_LOGINS_FAILED },
	{ IC_ERROR_BUSY, IC_DBUS_ERROR_BUSY },
};
